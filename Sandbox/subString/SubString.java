...
public class SubString {
	public static void main(String args[]) {
		...
		System.out.println("str.substring(0,7): " + str.substring(0,7));  // 0123456
		System.out.println("str.substring(0,8): " + str.substring(0,8));  // All numbers 01234567
		System.out.println("str.substring(0,1): " + str.substring(0,1));	// 0
		System.out.println("str.substring(0,2): " + str.substring(0,2));  // 01
		System.out.println("str.substring(8,8): " + str.substring(8,8));  // Nothing
		...
		// System.out.println("str.substring(9): " + str.substring(9));  // Will not work
	}
}